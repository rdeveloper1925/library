...
class TeachersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teachers.teachers')->with('users',$users);
    }
    ...
    {
        $dpts=DB::table('departments')->where('id','>',16)->get();
        return view('teachers.teachersCreate')->with('dpts',$dpts);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($user){
            $users=DB::table('users')->leftjoin('classes','users.classes_id','=','classes.id')
                ...
                ->leftjoin('roles','users.roles_id','=','roles.id')
                ->select('users.id','users.fName','users.lName','classes.name as className','users.user_departments_id as dptName','users.gender','roles.name as roleName')->get();
            return view('teachers.teachers')->with('users',$users)->with(['success'=>'Teacher Successfully registered']);
        }else{
            return view ('teachers.teachersCreate')->with('Fail','A Db error occured');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('teachers.teachersView')->with('student',$student);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->user_departments_id=Input::get('dpt');
        $user->save();
        return redirect('/teachers')->with(['success'=>'Teacher data successfully updated']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/teachers')->with(['success'=>'Teacher data successfully deleted']);
    }
}
