...
@section('content')
    ...
    <div class="col-md-12  container" style="padding: 13px;">
        <a href="/students" class="btn btn-md btn-success -pull-right"><span><i class="fa fa-backward"></i> </span> Go Back</a>
    </div>
        ...
        <div class="card shadow mb-12">
            ...
            <div class="card-body">
                <div class="form-group">
                    <a style="padding:0 13px 0 13px;width: 100%" href="/students/{{$student->id}}/edit" class="btn btn-warning btn-lg">Update Data</a>
                </div>
                <div class="form-group">
                    <button style="padding:0 13px 0 13px;width: 100%" onclick="areYou({{$student->id}})" class="btn btn-danger btn-lg">Delete User</button>
                    <script>
                        function areYou(id){
                ...
                <form action="/students/store" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" disabled value="{{\App\Classes::find($student->classes_id)->name}}" class="form-control form-control-user">
